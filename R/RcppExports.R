...
init_mcmc_state <- function(parent, child, relBrLengths, treeLength, rateLoss, rateLogSd, rateNeo, p, kPrime, logLik, logPrior, betaScale = 1.0, kprimeAlpha = 1.0, kprimeBeta = 1.0, phi = NULL, pi0 = 0.0, zMatrix = NULL, theta = NULL) {
    .Call(`_MkPrime_init_mcmc_state`, parent, child, relBrLengths, treeLength, rateLoss, rateLogSd, rateNeo, p, kPrime, logLik, logPrior, betaScale, kprimeAlpha, kprimeBeta, phi, pi0, zMatrix, theta)
}
...
.CppLogLikelihoodEcologyCached <- function(dataPtr, parent, child, edgeLen, kPrime, rateLoss, rateLogSd, rateNeo, phi, zMatrix, pi0 = 0.0, theta = NULL) {
    .Call(`_MkPrime_CppLogLikelihoodEcologyCached`, dataPtr, parent, child, edgeLen, kPrime, rateLoss, rateLogSd, rateNeo, phi, zMatrix, pi0, theta)
}
