...
trees <- ape::read.tree("inst/simulations/ecology/truth-init-results/truth-init_trees.nwk")
...
logCsv <- read.table("inst/simulations/ecology/truth-init-results/truth-init.log",
