...
HPC_DIR <- "/nobackup/pjjg18/mkp-sim3-multirep-v3/MkPrime/inst/hamilton/sim3-multirep-v3"
...
if (out$status != 0) {
  ...
  setup_local <- "inst/hamilton/sim3-multirep-v3/setup_project.sh"
...
ssh::scp_upload(session, "inst/hamilton/sim3-multirep-v3/sim3-multirep-v3.sh",
                to = paste0(HPC_DIR, "/"))
ssh::scp_upload(session, "inst/hamilton/sim3-multirep-v3/run_rep.R",
                to = paste0(HPC_DIR, "/"))
ssh::ssh_exec_internal(session,
