...
Scoring uses `inst/ecology/simulations/sim3-scoring.R::ScoreTreesUnrooted` 
...
Outputs:
- `inst/ecology/scripts/rescore-multirep-v3-results.{rds,csv}` (long form)
- `inst/ecology/scripts/rescore-multirep-v3-summary.csv` (wide form)
- `inst/ecology/scripts/rescore-multirep-v3-plot.pdf` (bar chart)
