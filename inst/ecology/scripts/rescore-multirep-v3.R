...
# ScoreTreesUnrooted) in inst/ecology/simulations/sim3-scoring.R.
#
...
#
# Outputs:
#   inst/ecology/scripts/rescore-multirep-v3-results.rds  (tidy tibble of all scores)
#   inst/ecology/scripts/rescore-multirep-v3-results.csv  (same, human-readable)
#   inst/ecology/scripts/rescore-multirep-v3-summary.csv  (one row per rep x chain,
#                                                  pivoted for readability)
#   inst/ecology/scripts/rescore-multirep-v3-report.md    (narrative summary)
#   inst/ecology/scripts/rescore-multirep-v3-plot.pdf     (per-rep blind vs aware
#                                                  P(AC) + P(AB) bar chart)
#
# Run locally from the MkPrime repo root with:
#   Rscript inst/ecology/scripts/rescore-multirep-v3.R
...
add("Scoring uses `inst/ecology/simulations/sim3-scoring.R::ScoreTreesUnrooted` ")
...
add("")
add("Outputs:")
add("- `inst/ecology/scripts/rescore-multirep-v3-results.{rds,csv}` (long form)")
add("- `inst/ecology/scripts/rescore-multirep-v3-summary.csv` (wide form)")
add("- `inst/ecology/scripts/rescore-multirep-v3-plot.pdf` (bar chart)")
