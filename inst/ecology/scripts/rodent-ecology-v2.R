...
#
# Outputs
#   - inst/ecology/scripts/rodent-ecology-v2-result.rds : RunMkPrime output + summaries
#   - inst/ecology/scripts/rodent-ecology-v2-zPost.csv  : per-(character, ecology)
...
mcmc <- MkPrimeMCMC(nIter = nIter, nChains = 1L, nRuns = 1L,
                    ...
                    logFile = "inst/ecology/scripts/rodent-ecology-v2.log",
                    checkpointFile = NULL)
...
if (!is.null(res$zSamples)) {
  ...
  write.csv(zPost, "inst/ecology/scripts/rodent-ecology-v2-zPost.csv",
            row.names = FALSE)
  cat("Wrote z posterior to inst/ecology/scripts/rodent-ecology-v2-zPost.csv\n")
  ...
  # Heatmap.
  pdf("inst/ecology/scripts/rodent-ecology-v2-heatmap.pdf", width = 6,
  ...
  dev.off()
  cat("Wrote heatmap to inst/ecology/scripts/rodent-ecology-v2-heatmap.pdf\n")
}
