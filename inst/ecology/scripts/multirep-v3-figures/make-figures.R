...
#   Rscript inst/ecology/scripts/multirep-v3-figures/make-figures.R
#
# Outputs (inst/ecology/scripts/multirep-v3-figures/):
...
outDir <- file.path(mkpRoot, "inst/ecology/scripts/multirep-v3-figures")
...
# ---------------------------------------------------------------------------
csvPath <- file.path(mkpRoot, "inst/ecology/scripts/aware-multirep-v3-posterior-shape.csv")
...
repDir <- file.path(mkpRoot, "inst/ecology/simulations/multirep-v3-results",
