...
scriptDir <- "inst/ecology/scripts/parsimony-trap-test"
...
datasets <- list(
  list(name = "v6-realistic", reps = 1:3,
       path = "inst/ecology/simulations/v6-realistic/rep%02d/blind-result.rds",
       falseEco = FALSE_ECO_8C, TL = 1.16),
  list(name = "multirep-v3",  reps = 1:8,
       path = "inst/ecology/simulations/multirep-v3-results/rep%02d/blind-result.rds",
       falseEco = FALSE_ECO_8C, TL = 13.5),
  list(name = "v5break",      reps = 1:3,
       path = "inst/ecology/scripts/parsimony-trap-test/v5break-data/v5break-rep%02d.rds",
