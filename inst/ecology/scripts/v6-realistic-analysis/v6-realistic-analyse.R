...
#
# Reads:
#   inst/ecology/simulations/v6-realistic/rep0{1,2,3}/
...
#
# Writes:
#   inst/ecology/scripts/v6-realistic-analysis/
...
source("inst/ecology/simulations/sim3-v6-params.R")

outDir  <- "inst/ecology/scripts/v6-realistic-analysis"
dir.create(outDir, showWarnings = FALSE, recursive = TRUE)
repDir  <- function(r) sprintf("inst/ecology/simulations/v6-realistic/rep%02d", r)
reps    <- 1:3
