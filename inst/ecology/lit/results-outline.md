...
- **Scoring**: root-invariant bipartition matching via `TreeTools::as.Splits`
  (`inst/ecology/simulations/sim3-scoring.R`); topology distance = normalised
...
- **Figure**: `inst/ecology/scripts/multirep-v3-figures/fig1-false-clade-support.pdf`
...
- **Figure**: `inst/ecology/scripts/multirep-v3-figures/fig2-cid-to-truth.pdf`
...
- **Claim**: the blind chain mode-locks onto wrong topologies containing the AB
  ...
  error.
- **Figure**: `inst/ecology/scripts/multirep-v3-figures/fig3-mds-rep02.pdf`
...
- **Claim**: at lower homoplasy (the v4/v4-cross family), the ecology confound
  ...
  signal is weak.
- **Table**: corrected per-clade support from `inst/ecology/scripts/rescore-sim3-results.csv`
...
- **Key numbers** (from `inst/ecology/scripts/rescore-multirep-v3-report.md`):
...
- **Note**: dedicated mode-trap audit document
  (`inst/ecology/scripts/aware-multirep-v3-caveat-reps-01-07.md`) is pending
  (task #17 in flight).
...
- **Figure**: CID-MDS scatter and MR consensus panels from
  `inst/ecology/scripts/rodent-comparison/` (figures from pilot run; will be
...
*All figures available as PDF and PNG in `inst/ecology/scripts/multirep-v3-figures/`.*
*Rodent comparison figures in `inst/ecology/scripts/rodent-comparison/`.*
*Numbers sourced from:*
*  `inst/ecology/scripts/rescore-multirep-v3-report.md`*
*  `inst/ecology/scripts/aware-multirep-v3-posterior-shape-report.md`*
*  `inst/ecology/scripts/rescore-sim3-report.md`*
*  `inst/ecology/scripts/rodent-comparison/rodent-comparison.md`*
