...
```bash
Rscript inst/simulations/ecology/sim1-null.R
```
...
```bash
Rscript inst/simulations/ecology/sim2-recovery.R
```
...
```bash
Rscript inst/simulations/ecology/sim3-v1v2-compare.R 200000
```
...
```bash
Rscript inst/simulations/ecology/sim3b-mcmc.R
```
...
```bash
Rscript inst/simulations/ecology/sim3-multirep.R 4 20260601 100000
```
...
```bash
Rscript inst/scripts/rodent-ecology-v2.R ~/downloads/mbank_X24848_2026-5-9-1135.nex 500000
```

~3 hr locally or ~1 hr HPC. Outputs:
* `inst/scripts/rodent-ecology-v2-result.rds`
* `inst/scripts/rodent-ecology-v2-zPost.csv`
...
See `inst/notes/v2-gibbs-z-perf.md` for the gibbs_z γ-cancellation
...
```bash
Rscript inst/simulations/ecology/sim-figures.R
```
