...
**Date:** 2026-05-20
**Driver:** `inst/scripts/parsimony-trap-test/parsimony-trap.R`
...
* `inst/scripts/parsimony-trap-test/parsimony-trap.R` — driver
* `inst/scripts/parsimony-trap-test/parsimony-trap-results.csv` — per (dataset, rep, weighting) row
* `inst/scripts/parsimony-trap-test/parsimony-trap-summary.csv` — per (dataset, weighting) aggregate
* `inst/scripts/parsimony-trap-test/parsimony-trap.log` — run log
* `inst/scripts/parsimony-trap-test/v5break-data/v5break-rep0{1,2,3}.rds` — local copies of Hamilton blind-result RDS (read-only)
