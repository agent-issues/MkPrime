...
Scoring is root-invariant via `inst/simulations/ecology/sim3-scoring.R`.
...
Outputs:
- `inst/scripts/aware-multirep-v3-posterior-shape.{rds,csv}`
- `inst/scripts/aware-multirep-v3-posterior-shape-credset.csv`
