...
# inst/simulations/ecology/sim3-scoring.R, and emit a tidy data frame with
...
#
# Outputs:
#   inst/scripts/rescore-sim3-results.rds  (tidy data frame)
#   inst/scripts/rescore-sim3-results.csv  (same, human-readable)
#   inst/scripts/rescore-sim3-root-dist.csv (root-position distributions)
#
# Run from the MkPrime root, e.g.:
#   MKP_LIB=/nobackup/pjjg18/mkp-sim3-multirep-v3/lib \
#   Rscript inst/scripts/rescore-sim3.R
...
source(file.path(mkpRoot, "inst/simulations/ecology/sim3v4cross-helpers.R"))
