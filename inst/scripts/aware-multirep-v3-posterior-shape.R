...
#
# Outputs:
#   inst/scripts/aware-multirep-v3-posterior-shape.rds       (R list)
#   inst/scripts/aware-multirep-v3-posterior-shape.csv       (per chain summary)
#   inst/scripts/aware-multirep-v3-posterior-shape-credset.csv (per topo, in CS or not)
#   inst/scripts/aware-multirep-v3-posterior-shape-report.md
#   inst/scripts/aware-multirep-v3-posterior-shape-plot.pdf
#
# Run from the MkPrime repo root with:
#   Rscript inst/scripts/aware-multirep-v3-posterior-shape.R
...
add("Scoring is root-invariant via `inst/simulations/ecology/sim3-scoring.R`.")
add("")
...
add("")
add("Outputs:")
add("- `inst/scripts/aware-multirep-v3-posterior-shape.{rds,csv}`")
add("- `inst/scripts/aware-multirep-v3-posterior-shape-credset.csv`")
add("- `inst/scripts/aware-multirep-v3-posterior-shape-plot.pdf`")
