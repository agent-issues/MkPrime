...
**Result file:** `inst/simulations/ecology/truth-init-results/`
...
- `inst/simulations/ecology/truth-init-results/` — raw outputs
- `inst/simulations/ecology/truth-init-diag.R` — chain.log dump
- `inst/simulations/ecology/truth-init-deep.R` — LogPrior decomposition
- `inst/simulations/ecology/truth-init-deeper.R` — warmup_trace + truth recompute
- `inst/simulations/ecology/truth-init-verify.R` — sample 1 recompute (the smoking gun)
- `inst/hamilton/sim3-truth-init/` — HPC dispatch scaffolding
