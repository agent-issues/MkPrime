...
if (tl_ok && pi0_ok) {
  report <- c(report,
    ...
    "driver (`inst/simulations/ecology/sim3-simulate.R` call site) to use",
  ...
  report <- c(report,
    ...
    "simulator's normalize=TRUE path in `inst/simulations/ecology/sim3-simulate.R`."
  )
}
...
report <- c(report,
  ...
  "- `inst/simulations/ecology/sim3-simulate.R` lines 150–185, 210–249 — simulator",
