...
| 0 (Eco orchestrator wall) | `dev/profiling/drivers/11_aware_vs_blind_rodent.R` | aware 24.59 (baseline) → 21.40 (T-010, -13.0 %) → 20.47 (T-011) → 20.58 (T-012) → **20.76 default / 20.69 gate-on (T-013, within noise — rodent dirty fraction 91 % median, partial-eval net ~0 %)** / blind 0.97 → 0.77 → 0.79 → 0.78 → 0.77 (200 iter, rodent MkNT, kEco=4, nTip=64, nChar=217) | `.Call → run_mcmc_batch_cpp` | 97.20 (Rprof, baseline) | 2026-05-21 (T-013) |
