...
| 0 (Eco orchestrator wall) | `dev/profiling/drivers/11_aware_vs_blind_rodent.R` | aware 24.59 (baseline) → **21.40 (T-010, -13.0 %)** / blind 0.97 → 0.77 (200 iter, rodent MkNT, kEco=4, nTip=64, nChar=217) | `.Call → run_mcmc_batch_cpp` | 97.20 (Rprof, baseline) | 2026-05-21 (T-010) |
