...
| 8 | Simulator vs model alignment (full)              | `inst/ecology/simulations/sim3-helpers.R`, `sim3-simulate.R`, `sim3-multirep.R`, `sim3-helpers.R` (tree construction)            | Tree topology + edge ecology mapping. Seed reproducibility. Unit consistency between simulator and model (gamma_e normalisation, baseRate). `kEco ≠ 2` extension hazards.                                          |
...
| 11| HPC dispatch + Hamilton scripts                 | `inst/ecology/hamilton/sim3-multirep-v3/*`; `inst/ecology/hamilton/sim3-truth-init/*`                                                            | Error handling. Resource correctness. Log management. DOS line endings. Idempotency. Env var handling. SSH/scp gotchas.                                                                                              |
