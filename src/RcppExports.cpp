...
// init_mcmc_state
SEXP init_mcmc_state(IntegerVector parent, IntegerVector child, NumericVector relBrLengths, double treeLength, double rateLoss, double rateLogSd, double rateNeo, double p, IntegerVector kPrime, double logLik, double logPrior, double betaScale, double kprimeAlpha, double kprimeBeta, Rcpp::Nullable<Rcpp::NumericVector> phi, double pi0, Rcpp::Nullable<Rcpp::IntegerMatrix> zMatrix, Rcpp::Nullable<Rcpp::NumericVector> theta);
RcppExport SEXP _MkPrime_init_mcmc_state(SEXP parentSEXP, SEXP childSEXP, SEXP relBrLengthsSEXP, SEXP treeLengthSEXP, SEXP rateLossSEXP, SEXP rateLogSdSEXP, SEXP rateNeoSEXP, SEXP pSEXP, SEXP kPrimeSEXP, SEXP logLikSEXP, SEXP logPriorSEXP, SEXP betaScaleSEXP, SEXP kprimeAlphaSEXP, SEXP kprimeBetaSEXP, SEXP phiSEXP, SEXP pi0SEXP, SEXP zMatrixSEXP, SEXP thetaSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< IntegerVector >::type parent(parentSEXP);
    ...
    rcpp_result_gen = Rcpp::wrap(init_mcmc_state(parent, child, relBrLengths, treeLength, rateLoss, rateLogSd, rateNeo, p, kPrime, logLik, logPrior, betaScale, kprimeAlpha, kprimeBeta, phi, pi0, zMatrix, theta));
    return rcpp_result_gen;
END_RCPP
}
...
// CppLogLikelihoodEcologyCached
double CppLogLikelihoodEcologyCached(SEXP dataPtr, IntegerVector parent, IntegerVector child, NumericVector edgeLen, IntegerVector kPrime, double rateLoss, double rateLogSd, double rateNeo, NumericVector phi, IntegerMatrix zMatrix, double pi0, Rcpp::Nullable<Rcpp::NumericVector> theta);
RcppExport SEXP _MkPrime_CppLogLikelihoodEcologyCached(SEXP dataPtrSEXP, SEXP parentSEXP, SEXP childSEXP, SEXP edgeLenSEXP, SEXP kPrimeSEXP, SEXP rateLossSEXP, SEXP rateLogSdSEXP, SEXP rateNeoSEXP, SEXP phiSEXP, SEXP zMatrixSEXP, SEXP pi0SEXP, SEXP thetaSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< SEXP >::type dataPtr(dataPtrSEXP);
    ...
    Rcpp::traits::input_parameter< double >::type pi0(pi0SEXP);
    Rcpp::traits::input_parameter< Rcpp::Nullable<Rcpp::NumericVector> >::type theta(thetaSEXP);
    rcpp_result_gen = Rcpp::wrap(CppLogLikelihoodEcologyCached(dataPtr, parent, child, edgeLen, kPrime, rateLoss, rateLogSd, rateNeo, phi, zMatrix, pi0, theta));
    return rcpp_result_gen;
END_RCPP
}
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< Rcpp::NumericVector >::type empLogBody(empLogBodySEXP);
    ...
    Rcpp::traits::input_parameter< double >::type thetaAlpha(thetaAlphaSEXP);
    Rcpp::traits::input_parameter< double >::type thetaBeta(thetaBetaSEXP);
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_MkPrime_init_mcmc_state", (DL_FUNC) &_MkPrime_init_mcmc_state, 18},
